...
">
    ...
    <div class="py-12">
        ...
        <form class="px-4" action="{{ route('posts.update', $posts->id) }}" method="POST">
            @csrf
            @method('PUT')
            @if ($errors->any())
            ...
            <div  class="mb-3">
                ...
                <input type="text"  value="{{ $posts->title }} " name="title" class="block p-2 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            </div>
            <button type="submit"
